...
// Operadores de asignacion básico = y Compuestos +=, -=, *=, /=, %=, **=
...
Mayor/menor: >, <, >=, <=
Igualdad débil == (compara valor, hace conversiones)
Igualdad estricta === (compara valor y tipo)
Desigualdad !=, Desigualdad estricta !== */
...
OR || → true si alguna condición es true
NOT ! → niega/invierte un boolean*/
